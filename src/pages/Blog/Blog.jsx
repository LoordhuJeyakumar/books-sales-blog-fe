...
const Blog = () => {
  ...
  useEffect(() => {
    ...
    dispatch(allBlogs(searchParams.toString())).then((response) => {
      if (response.payload.count / 9 === 1) return setCount(0);
        ...
        <div className={styles.blogsInner}>
          <div className={styles.categoriesContainer}>
            <div className={styles.categories}>
              <select value={changeQuery} onChange={handleOptionChange}>
          ...
          <Articles />
          {(results.length > 8 || currentPage > 1) && (
