...
const Reviews = ({ review, data, getBook }) => {
  ...
  return (
    <div className={styles.reviewContainer}>
      ...
      <form onSubmit={reviewHandler} className={styles.reviewForm}>
        <textarea
          required
          value={text}
      ...
      {review?.map((review) => {
        return (
          <div className={styles.singleReview} key={review._id}>
            ...
            <div className={styles.rightText}>
              ...
              <div className={styles.reviewRate}>
                <ReactStars edit={false} value={review.rating} count={5} />
              </div>
