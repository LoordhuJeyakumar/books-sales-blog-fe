      ...
      <div className={styles.innerContainer}>
        <div className={styles.leftWrapper}>
          <Link className={styles.logoWrapper} to="/">
            <img width={24.5} src={vector} alt="Books Website logo" />
            <p>PagePulse</p>
          </Link>
        ...
        >
          <ul className={styles.pagesList}>
            ...
            <li>
              <Link to={"/blog"} onClick={toggleHandler}>
                Blog
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link to={"/comingsoon"} onClick={toggleHandler}>
                Contact
              </Link>
            </li>
            {user?.length !== 0 && (
              ...
              >
                <img width={22} src={basketImg} alt="basket" />
                <p>
          ...
          {user?.length !== 0 ? (
            ...
            <div className={styles.orderTodayWrapper}>
              ...
              <div>
                <Link onClick={toggleHandler} to="/signup">
                  Signup
                </Link>
                <Link onClick={toggleHandler} to="/login">
                  Login
                </Link>
              </div>
            </div>
